...
jsPsych.plugins['iat-button'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // styling elements 
    var button_height = 0.11 * Math.min(window.innerHeight, window.innerWidth);
    ...
    if (trial.display_fixation == true) {
      html_str += "<div class='disp_fixation' id='disp_fixation_html' style='visibility: hidden; position: absolute; font-size:" +
        1.5 * (button_height) + "px; z-index: 0; '>" + trial.fixation_html + "</div>";
    }
    // stimulus words
    html_str += "<p id='jspsych_iat_stim_word' style='font-size:" +
      1.0 * (button_height) + "px;; z-index: 1; '>" +
      trial.stim_word + "</p>";
    // stimulus image
    ...
    html_str += "<button disabled=true id='btn_iat_left' class='button btn_iat btn_iat0' style='height:" +
      button_height + "px; width:" +
      3.8 * button_height + "px; left:5%; bottom: 5%; font-size:" +
      0.35 * button_height + "px;' data-choice='0'>";
    ...
    html_str += "<button disabled=true id='btn_iat_right' class='button btn_iat btn_iat1' style='height:" +
      button_height + "px; width:" +
      3.8 * (button_height) + "px; right: 5%; bottom: 5%; font-size:" +
      0.35 * (button_height) + "px;' data-choice='1'>";
    ...
    if (trial.display_feedback == true) {
      ...
      button_height + "px; left: 0; right: 0; bottom: 5%; margin: auto; z-index: 5;' src=" + trial.html_when_wrong + "></div>";
    } else {
      html_str += " ";
    }
    // finish styling
    ...
    function start_trial() {
      ...
      for (var j = 0; j < btns.length; j++) {
        ...
        // record click 
        display_element.querySelector('.btn_iat' + j).addEventListener('click', function(e) {
    ...
    function after_response(choice) {
      ...
      if ((trial.stim_btn_association == "left" || trial.stim_btn_association == "right") && response.button !== trial.stim_btn_association) {
        ...
        console.log("wrong response: ", response.correct);
        ...
        console.log("right response: ", response.correct);
    ...
    function end_trial() {
      ...
      console.log("collected data", trial_data);
