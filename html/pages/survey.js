...
// generate user info from time and date

var uuid;
function create_UUID(){
    var dt = new Date().getTime();
    uuid = 'xxi-xfxxx-txxx-xxxx-xxxxxx'.replace(/[xy]/g,function(c) {
        var r = (dt + Math.random()*19)%19 | 0;
        dt = Math.floor(dt/19);
        return (c=='x' ? r :(r&0x3|0x8)).toString(19);
    });
    return uuid;
}
console.log(create_UUID());

var experiment_page = './experiment.html?subject=' + create_UUID();

var timestamp = new Date();
var primingType;
if (new Date().toISOString().slice(-4,-3) < 2) {
 primingType = 0; 
}
else if (new Date().toISOString().slice(-4,-3) <6) {
  primingType = 1;
  } else{
  primingType = 2;
  }
...
function surveyValidateQuestion(s, options) {
    if (options.name == 'none_ms_imagine' || options.name == 'ms_imagine') {
        if (options.value.indexOf("我") < 0) {
            options.error = "请在描述中提及自己（例如，“我感到....”）";
        }
    }
}
...
var json = {
  "title": " IFT ",
  "description": "Implicit Association Test for TMT",
  "locale": "zh-cn",
  ...
  "pages": [
    ...
    },
	{
     ...
     "defaultValue": primingType,
    },
        {
          ...
          "html": "<br><p class='sv_instruction'>以下部分将询问一些关于你的个人信息的问题，以便我们在研究中比较不同人群之间的差异。<br>本页题目全部填写后，页面将自动进入下一页。</p></div>"
        },
    ...
    },
    {
      ...
      "elements": [{
          "type": "html",
          "name": "ses_intro",
          "html": "<br><p class='sv_instruction' style='color: black; font-size: 1.2em;'>请想象下图中的梯子代表了我们社会中人们的位置：<br><br>最高 “10 ”代表<b>最顶层</b>——那里的人们拥有最多的财富、最受尊敬的地位；最低“1 ”代表<b>最底层</b>——那里的人们拥有最少的财富、最不受尊敬的地位。在梯子上的位置越高，表示社会地位越高，反之则表示社会地位越低。<br><br> <big style='font-size: large;'><b>相对于社会中的其他人来说，你认为自己位于梯子中的那一层呢？</b></big> <br><br> 请从以下“1”到“10”的数字中选择一个来代表你<b>当前</b>所在的等级：</p>"
        },
        {
          "type": "panel",
        ...
        },
        {
          "type": "html",
          "name": "ses_intro_past",
          "html": "<br><p class='sv_instruction' style='color: black; font-size: 1.2em;'> <br> 请从以下“1”到“10”的数字中选择一个来代表你在<b>十年前</b>所在的等级：</p>"
        },
        {
          "type": "dropdown",
          "name": "ses_scale_past",
        ...
        },
        {
          ...
          "html": "<br><p class='sv_instruction' style='color: black; font-size: 1.2em;'> <br> 请从以下“1”到“10”的数字中选择一个来代表你<b>14岁时</b>家庭所在的等级：</p>"
        },
        {
          "type": "dropdown",
	...
	},
    {
      ...
      "elements": [
        ...
        },
        {
          ...
          "name": "ms_imagine",
		  "visibleIf": "{priming_type} <2",
          "title": "假如你即将面临一场非常重要的面试，请想象这一场景和你在当时的感受，并在下面描述出来。表达的方式不限，但希望你能多花一些时间，深入思考和体会、尽可能详细地描述细节。 ",
          "isRequired": true,
          "validators": [{
            "type": "text",
            "minLength": 30,
        ...
        },
        {
          ...
          "visibleIf": "{priming_type} >1",
          "title": "假如你即将面临一场手术，请想象这一场景和你在当时的感受，并在下面描述出来。表达的方式不限，但希望你能多花一些时间，深入思考和体会、尽可能详细地描述细节。 ",
          "isRequired": true,
          "validators": [{
            "type": "text",
            "minLength": 30,
   ...
   "elements": [
    {
     ...
     "name": "PANAS_intro",
     "html": {
      "zh-cn": "<br><p class='sv_instruction'>以下部分将询问一些关于你近期情绪状况的问题。请阅读以下形容情绪的词语，根据你近1-2周的实际情况，逐一评价它们在你近期情绪中占有的比例。</p><p class='sv_description'>“1”分代表“几乎没有”，<br>“2”分代表“比较少”，<br>“3”分代表“中等程度”，<br>“4”分代表“比较多”，<br>“5”分代表“极其多”。</p>"
     }
    },
    {
     "type": "rating",
...

    {
      ...
      "elements": [
          ...
          "type": "html",
          "name": "LES_intro",
          "html": "<br><p class='sv_instruction'>以下部分将询问一些关于你成长经历的问题。请回忆你的14岁之前的经历，然后评价以下说法是否符合你的成长经历的实际情况。</p><p class='sv_description'>“1”分代表“完全不符合”，<br>“2”分代表“较不符合”，<br>“3”分代表“说不清”，<br>“4”分代表“比较符合”，<br>“5”分代表“完全符合”。</p>"
        },
    {
     "type": "rating",
     "name": "SES_C1",
  ...
  "elements": [
          ...
          "type": "html",
          "name": "SQ_intro",
          "html": "<br><p class='sv_instruction'>以下部分将询问一些关于你个性特点的问题。请回想你平时的感受，并评价以下说法是否符合你的实际情况。</p><p class='sv_description'>“1”分代表“完全不符合”，<br>“2”分代表“较不符合”，<br>“3”分代表“说不清”，<br>“4”分代表“比较符合”，<br>“5”分代表“完全符合”。</p>"
        },
    {
     "type": "rating",
     "name": "SQ01",
  ...
  "elements": [
          ...
          "type": "html",
          "name": "DAS_intro",
          "html": "<br><p class='sv_instruction'>以下部分将询问你对待生命的态度。请回想你平时的感受，并评价你是否同意以下说法。</p><p class='sv_description'>“1”分代表“非常不同意，<br>“2”分代表“不太同意”，<br>“3”分代表“不确定”，<br>“4”分代表“比较同意”，<br>“5”分代表“非常同意”。</p>"
        },
    {
     "type": "rating",
     "name": "DAS01",
