  ...
  "pages": [{
    ...
    },
    {
      ...
      "elements": [{
        ...
        },
        {
          ...
          "html": {
            "en-us": "<br><p class='sv_instruction'>In this task you will be asked questions about your experiences with COVID-19. <br>COVID-19, the disease caused by the virus SARS-CoV-2, was declared a pandemic by the World Health Organization Director-General on 11 March 2020. In countries most severely impacted by the disease, case fatality rates are thought to be as high as 15%. Due to its contagiousness, COVID-19 poses both a physical threat, causing more than 2 million deaths worldwide, and also a psychological threat through the fear it provokes. </div>",
            "zh-cn": "<br><p class='sv_instruction'>以下部分将询问你在新冠疫情中的个人经历。<br><br>2019冠状病毒病（COVID-19）是一种由严重急性呼吸系统综合症冠状病毒2型引发的传染病。自2019年末起，此病在全球各国大规模爆发并急速扩散，成为人类历史上致死人数最多的流行病之一。截至2021年2月底，全球已有192个国家和地区累计报告超过1.11亿名确诊病例，逾247.6万名患者死亡。与此同时，新冠疫情也对人们的心理健康造成了威胁。因此，我们希望了解你在疫情中受到影响的程度与方式。请你回想自己的有关经历与实际状况，并回答以下问题。</div>",
          }
    ...
    },
    {
      ...
      "elements": [{
          ...
          "name": "PANAS_intro",
          "html": {
            "zh-cn": "<p class='sv_instruction' style='margin-top: 0.5em;'>以下部分与你当前的情绪状况有关。请阅读以下形容情绪的词语，逐一评价它们在你情绪中占有的比例。</p><p class='sv_description'>“1”分代表“几乎没有”，<br>“2”分代表“比较少”，<br>“3”分代表“中等程度”，<br>“4”分代表“比较多”，<br>“5”分代表“极其多”。</p>"
          }
        },
        {
          "type": "panel",
...

	{
      ...
      "elements": [{
          "type": "html",
          "name": "demograph_intro",
          "html": "<p class='sv_instruction'>以下部分还需要询问你的个人相关信息，以便我们在研究中比较不同人群之间的差异。<br></p></div>"
        },
